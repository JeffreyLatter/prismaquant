...
clip; block-output match, HALO, and AWQ predecessor folding remain on the
export-only side --- and the move set is restructured to start from a
...
HALO, and AWQ predecessor folding remain on the export-only side and are
not yet replicated in the polish-time evaluator), and the move set is a
