...
sensitivity but errors that compound through later attention.
PrismaSCOUT does not change a single per-Linear technique; it changes
the allocator from \emph{additive surrogate cost} to \emph{validated
end-KL on real assignments}, and it gates every shipping decision on a
held-out KL measurement. The Qwen3.6-27B head-to-head in
