...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    p.add_argument(
        ...
        "activation clipping solver. Requesting the NVFP4_CLIPPED format "
        "renders PrismaClip as a separate same-bpp candidate instead of "
        "rewriting baseline NVFP4. fisher_clip is PrismaFisherClip: it "
