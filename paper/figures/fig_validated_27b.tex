...
split for Qwen3.6-27B. The surrogate-only kneedle on the same set picks
$5.857$\,bpp at KL $0.056$ (blue square). The validated kneedle picks
$5.3117$\,bpp at KL $0.0151$ (green dot, shipped artifact). The previously
shipped \textsc{PrismaQuant}~v1 artifact at $5.50$\,bpp / KL $0.0475$ (gray
triangle) sits clearly inside the validated frontier --- the new selector
finds a strictly better point at lower bpp.}
\label{fig:surrogate_vs_validated}
