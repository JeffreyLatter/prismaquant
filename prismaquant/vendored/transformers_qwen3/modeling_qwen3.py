...
class Qwen3RotaryEmbedding(nn.Module):
    ...
    def __init__(self, config: Qwen3Config, device=None):
        ...
        inv_freq, self.attention_scaling = self._compute_rope_parameters(device)
    ...
    def _compute_rope_parameters(self, device=None) -> tuple[torch.Tensor, float]:
    ...
    def reset_rope_cache(self, device=None) -> None:
        if device is None:
            device = getattr(getattr(self, "inv_freq", None), "device", None)
...
class Qwen3PreTrainedModel(PreTrainedModel):
    ...
    def _prismaquant_reset_rope_caches(self) -> None:
        try:
        ...
        for module in self.modules():
            if isinstance(module, Qwen3RotaryEmbedding):
                module.reset_rope_cache(device=device)
