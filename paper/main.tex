...
\cite{gptq2022} or AWQ \cite{awq2024}. A tuned per-tensor toolkit runs
...
operative quality lever; on the production Qwen-3.6 27B artifact, the
allocator selects 117 BF16 Linears, 379 NVFP4 Linears, and 0 MXFP8
Linears under the chosen budget --- a distribution no single-format
method can produce.
...
$\tfrac12 \langle H_i, (W_i - \hat W_i)^2 \rangle$: HALO reduces
