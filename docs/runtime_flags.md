...
| `PRISMAQUANT_ACT_CLIP_SOLVER_MAX_EVALS` | `6` | Maximum threshold evaluations per eligible group for the log-space scalar solver. Higher values can improve the threshold but multiply NVFP4 render cost. |
