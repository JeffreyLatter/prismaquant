...
# independently pinned 0.8.10/v4 release wheel and its published SHA-256.
...
if pin["version"] != "0.8.10" or pin["version_is_release"] is not True:
    raise SystemExit(f"{path}: Gridbook 0.8.10 is not marked released")
